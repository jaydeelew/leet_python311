...
class Solution:
    def findWinners(self, matches: list[list[int]]) -> list[list[int]]:
        ...
        for winner, loser in matches:
            losses_count[winner] = losses_count.get(winner, 0)  # if winner dne, add key w/ value 0, else value unchanged
            losses_count[loser] = losses_count.get(loser, 0) + 1  # if loser dne, add key w/ value 1, else increment
